<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('admin.recipes.index') }}">
                <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#012970" height="16px" width="16px" version="1.1" id="Capa_1" viewBox="0 0 56.999 56.999" xml:space="preserve">
                    <g>
